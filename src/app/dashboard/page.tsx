...
export default function DashboardPage() {
  return (
    ...
    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch px-6">
        {/* LEFT: Calendar card */}
        <section className="rounded-2xl overflow-hidden bg-[#F7ECD9] border border-black/10">
          {/* Maroon header */}
          <div className="bg-[#3d0000] text-white px-5 py-6 flex items-center justify-between">
            {/* Left side */}
            <div className="text-lg font-semibold flex items-center gap-3">
              <span className="inline-flex items-center justify-center h-7 w-7 rounded-full bg-white/15">
                ≡
              </span>
