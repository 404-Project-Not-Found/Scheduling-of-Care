...
const initialRequests: Request[] = [
  {
    ...
    dateRequested: '28th June 2025',
    status: 'Pending',
    resolutionDate: '-',
  },
  {
    task: 'Dental Appointments',
    change: 'Add an oral cancer screening appointment on the 6th June 2025',
    requestedBy: 'Mary (POA)',
    dateRequested: '19th May 2025',
    status: 'Approved',
    resolutionDate: '25th May 2025',
  },
  {
    task: 'Daily Medication',
    change: 'Add Vitamin D supplement in mornings',
    requestedBy: 'John (Family)',
    dateRequested: '10th May 2025',
    status: 'Pending',
    resolutionDate: '-',
  },
  {
    task: 'Dietary Plan',
    change: 'Reduce sugar intake and add more vegetables',
    requestedBy: 'Mary (POA)',
    dateRequested: '5th May 2025',
    status: 'Approved',
    resolutionDate: '12th May 2025',
  },
  {
    task: 'Exercise Schedule',
    change: 'Add yoga sessions twice weekly',
    requestedBy: 'John (Family)',
    dateRequested: '1st May 2025',
    status: 'Pending',
    resolutionDate: '-',
  },
];
  ...
  return (
    <>
              ...
              <tbody>
                {sortedRequests.length > 0 ? (
                  sortedRequests.map((req, idx) => (
                    <tr
                      key={idx}
                      className="border-b hover:bg-[#ffeedd] transition"
                    >
      ...
      <div className="fixed bottom-6 right-6 group">
        <button className="bg-[#ff9999] text-white w-12 h-12 rounded-full shadow-lg text-lg flex items-center justify-center">
          ?
        </button>
