...
export default function StaffScheduleCalendarPage() {
  ...
  const addCarer = () => {
    ...
    if (carers.some((c) => c.id === id || c.name === name))
      return alert('Carer Already Exists');
      ...
      >
        <div className="flex items-center gap-8">
          ...
          <div>
            ...
            <div className="text-sm text-white/80">
              Manage Who Is On Shift And Set Shift Hours
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            style={{ borderColor: THEME.border, color: 'white' }}
          >
            ◀
          </button>
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6 text-black">
            ...
            <input
              ...
              onChange={(e) =>
                setAddCarerModal((prev) => ({ ...prev, name: e.target.value }))
              }
          ...
          <div className="bg-white rounded-2xl shadow-lg w-full max-w-md p-6 text-black">
            ...
            <div className="flex gap-2 mb-4 flex-wrap">
              {Object.entries(shiftPresets).map(([label, { start, end }]) => (
                <button
                  key={label}
                  onClick={() => setModal((m) => ({ ...m, label, start, end }))}
