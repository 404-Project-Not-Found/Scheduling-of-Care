...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#fff4e6] relative">
      ...
      {/* Title */}
      <h1 className="text-2xl font-bold text-black mb-8 text-center">Reset Password</h1>
      ...
      >
        <div className="grid grid-cols-[150px_1fr_auto] gap-x-2 gap-y-4 w-full max-w-md items-center">
          {/* New Password */}
          <label className="text-black text-right whitespace-nowrap">New Password:</label>
          <input
          ...
          {/* Confirm Password */}
          <label className="text-black text-right whitespace-nowrap">Confirm Password:</label>
          <input
      ...
      {/* Back to login */}
      <button onClick={() => router.push("/login")} className="mt-6 text-black underline">
        Back to Login
      </button>
      ...
      <div className="fixed bottom-6 right-6 group">
        ...
        {showHelp && (
          <div className="absolute bottom-12 right-0 bg-white text-black text-xs px-3 py-2 rounded shadow-md whitespace-nowrap z-10">
            Enter your new password twice and click &quot;Reset&quot;. Both passwords must match.
            Click &quot;Show Password&quot; to view.
          </div>
        )}
      </div>
    </div>
