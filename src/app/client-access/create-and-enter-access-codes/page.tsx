...
export default function ClientAccessPage() {
  ...
  return (
    <div className="h-screen w-full bg-[#F3E9D9] text-zinc-900 flex flex-col items-center justify-start p-8 relative">
      ...
      <div className="absolute top-8 left-8 w-64 h-32"> {/* increased size */}
      ...
      <div className="w-full max-w-6xl grid grid-cols-2 gap-12 mt-16">
        ...
        <div className="bg-[#F7ECD9] rounded-2xl shadow-lg overflow-hidden min-h-[500px]">
          ...
          <div className="p-16">
            ...
            {/*left panel messages */}
            {message && (
              <div className={`mt-6 p-4 rounded ${message.type === 'success' ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'} border text-base`}>
                {message.text}
              </div>
            )}
        ...
        <div className="bg-[#ffd9b3] rounded-2xl p-16 shadow-lg min-h-[500px]">
          ...
          <div className="flex gap-4 mb-6">
            <input
              value={input}
              onChange={(e) => { setInput(e.target.value); setInputAttempted(true); setSubmissionMessage(null); }}
          ...
          <p className="text-base mb-6">
            Forgot access code? Contact <Link href="#" className="underline cursor-pointer">your management</Link>
          </p>

          {/*bottom submission message */}
          {submissionMessage && (
            <div className={`mt-6 p-4 rounded ${submissionMessage.type === 'success' ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'} border text-base`}>
      ...
      <div className="absolute bottom-8 right-8">
        <div className="relative">
          <div className="w-12 h-12 bg-[#ff9900] text-white rounded-full flex items-center justify-center font-bold text-xl cursor-pointer"
