...
const palette = {
  canvas: '#FAEBDC', // Drawer background
...
/**
 * Right-side sliding drawer used inside Client Profile page.
 * Contains logic to generate, copy, and share access codes.
 */
    ...
    >
      ...
      <section className="flex-1 flex flex-col items-center justify-start">
        <div className="mt-16 flex items-center justify-center gap-4 sm:gap-5 flex-wrap">
          ...
          {/* Read-only input with generated code */}
          <input
            value={code}
            readOnly
          ...
          {copied && (
            <span
              className={`text-sm ${
                copied === 'ok' ? 'text-green-700' : 'text-red-600'
              }`}
            >
      ...
      <div className="absolute bottom-6 right-6">
        ...
        {showHelp && (
          <div className="absolute bottom-12 right-0 w-80 bg-white border border-gray-300 p-4 rounded shadow-lg text-sm z-10">
            <h4 className="font-semibold mb-2">How to use this panel</h4>
