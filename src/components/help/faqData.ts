    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'A: Click “My PWSN”, select a person, then click on "edit profile" to edit details. Otherwise, Click the person’s avatar (center of the pink banner) of selected PWSN to open their profile and update details.',
          ...
          'A: Click your avatar (top right of the page, right side of the top banner) to open account settings or sign out.',
